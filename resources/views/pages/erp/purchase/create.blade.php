        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <!-- info row -->
              <div class="row invoice-info pb-5" style="display:flex; padding-bottom:180px;">
                <div class="col-sm-4 invoice-col">
                  Warehouse
                  <address>
                  <select id="cmbWarehouse" name="cmbWarehouse">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    ?>
                    <select id="cmbSupplier" name="cmbSupplier">
